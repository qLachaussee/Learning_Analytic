...
def main():
    ...
    if graph_to_show == "Description des modules":
        ...
        with st.expander("Nombre de clique moyen par module :"):    
            student_vle_filtered_MP = filtre_par_3(dataset_dict["studentVle"], code_module, code_presentation)
    ...
    if graph_to_show == "Prédiction":
        ...
        st.markdown(f"<h6 style='color:darkgoldenrod; margin-bottom:-25px;'>Conseil : '{modeles[0]}' présente le meilleur taux de réussite.</h6>", unsafe_allow_html=True)
